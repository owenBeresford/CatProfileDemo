...
export type CatStateType={ allCats:Array<Cat>|null, cat:Cat|null, key:string };
export type CatAction = Action & { collection:Array<Cat>|null, single:Cat|null, key:string }; 
