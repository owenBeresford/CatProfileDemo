...
const bigCat:Cat={
    ...
    "Swimming",
    "Track and Field" ],
    about: "sdfsf asdfads adg.admg;ljsdfgk hsd;flgj ;adslfg;adg;oad g;lkad h;gklsdh fkjghasdf;kghjad;lkgh ad;klfg hafg hakl;dfhg kadfh g;aldkladj fglojhg ;adlfg;alkdshg;kladh g;lkadhg adhfg ;adshglakshblakdsg asklu fgaskasha s;las;l adlk;sgh ad;sgha dsgiad gj ad gad ijrgd.as,rg n;klrj l;arhj ;alrga;lh ;als g;klashg;klas hjg;asg;klawsh j;l g;liasd ;oig jh;slewgh;aG AH;SDG H;AS G",
  ...
  // this a text-charactor rendering test; I have no persona for this profile
...
export const STEP0 = () => { return (<ShowCat current={null} isChild={true}  />) };
export const STEP1 = () => { return (<ShowCat current={null} isChild={false}  />) };
export const STEP2  = () => { return (<ShowCat current={smolCat} isChild={true}  />) }; 
export const STEP3  = () => { return (<ShowCat current={smolCat} isChild={false}  />) }; 
export const STEP4  = () => { return (<ShowCat current={bigCat} isChild={true}  />) }; 
export const STEP5  = () => { return (<ShowCat current={bigCat} isChild={false}  />) }; 
export const STEP6 = () => { return (<ShowCat current={genericAsiaCat} isChild={false}  />) }; 
