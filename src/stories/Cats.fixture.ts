...
const bigCat: Cat = {
  ...
  about:
    "(long / big data) sdfsf asdfads adg.admg;ljsdfgk hsd;flgj ;adslfg;adg;oad g;lkad h;gklsdh fkjghasdf;kghjad;lkgh ad;klfg hafg hakl;dfhg kadfh g;aldkladj fglojhg ;adlfg;alkdshg;kladh g;lkadhg adhfg ;adshglakshblakdsg asklu fgaskasha s;las;l adlk;sgh ad;sgha dsgiad gj ad gad ijrgd.as,rg n;klrj l;arhj ;alrga;lh ;als g;klashg;klas hjg;asg;klawsh j;l g;liasd ;oig jh;slewgh;aG AH;SDG H;AS G",
  interests:
...
const genericArabCat: Cat = {
  ...
  sports: ["American Football"],
  about:
    "(arabic utf8 plane, should be RTL) (ابن منظور: لسان العرب)، وعرّف أيضا بـ (هو: النظم الموزون، وحده ما تركّب تركباً متعاضداً، وكان مقفى موزوناً، مقصوداً به ذلك. فما خلا من هذه القيود أو بعضها فلا يسمى (شعراً) ولا يُسمَّى قائله (شاعراً)، ولهذا ما ورد في الكتاب أو السنة موزوناً، فليس بشعر لعدم القصد والتقفية، وكذلك ما يجري على ألسنة الناس من غير قصد؛ لأنه مأخوذ من (شعرت). ",
  interests:
